...
#define UBO_ CirclePermutationUBO
    {UBO_STRING(CirclePermutationUBO), {
        FIELD(color),
        FIELD(radius),
        FIELD(blur),
        FIELD(opacity),
...
#define UBO_ FillExtrusionPermutationUBO
    {UBO_STRING(FillExtrusionPermutationUBO), {
        FIELD(color),
        FIELD(base),
        FIELD(height),
        FIELD(pattern_from),
...
#define UBO_ FillPermutationUBO
    {UBO_STRING(FillPermutationUBO), {
        FIELD(color),
        FIELD(opacity),
        FIELD(overdrawInspector),
    }},
...
#define UBO_ FillOutlinePermutationUBO
    {UBO_STRING(FillOutlinePermutationUBO), {
        FIELD(outline_color),
        FIELD(opacity),
        FIELD(overdrawInspector),
    }},
...
#define UBO_ FillPatternPermutationUBO
    {UBO_STRING(FillPatternPermutationUBO), {
        FIELD(pattern_from),
        FIELD(pattern_to),
        FIELD(opacity),
        FIELD(overdrawInspector),
...
#define UBO_ FillOutlinePatternPermutationUBO
    {UBO_STRING(FillOutlinePatternPermutationUBO), {
        FIELD(pattern_from),
        FIELD(pattern_to),
        FIELD(opacity),
        FIELD(overdrawInspector),
...
#define UBO_ HeatmapPermutationUBO
    {UBO_STRING(HeatmapPermutationUBO), {
        FIELD(weight),
        FIELD(radius),
        FIELD(overdrawInspector),
    }},
...
#define UBO_ ExpressionInputsUBO
    {UBO_STRING(ExpressionInputsUBO), {
        FIELD(time_lo),
        FIELD(time_hi),
        FIELD(frame_lo),
        FIELD(frame_hi),
...
#define UBO_ LinePermutationUBO
    {UBO_STRING(LinePermutationUBO), {
        FIELD(color),
        FIELD(blur),
        FIELD(opacity),
        FIELD(gapwidth),
...
#define UBO_ SymbolPermutationUBO
    {UBO_STRING(SymbolPermutationUBO), {
        FIELD(fill_color),
        FIELD(halo_color),
        FIELD(opacity),
        FIELD(halo_width),
